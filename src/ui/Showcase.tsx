...
export function Showcase({ session, panel, presented, cursor, infoOn, lastAdvanceMs, intervalMs, pulse, lensOn, marker, width, height, commits, full, progress, filesSort, tasksHideDone, paletteOpen, paletteQuery, paletteGhost }: Props) {
  if (!session) {
    return (
